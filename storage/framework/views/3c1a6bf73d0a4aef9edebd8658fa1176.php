<?php $__env->startSection('title', 'Dashboard - FoodSaver'); ?>
            ...
            <div class="flex flex-col md:flex-row items-center justify-between gap-8">
                <div class="flex items-center space-x-6">
                    <div class="relative group">
                        <img src="<?php echo e(Auth::user()->Foto_Profil ? asset('storage/' . Auth::user()->Foto_Profil) : asset('images/user-placeholder.jpg')); ?>" 
                    ...
                    <div>
                        <h1 class="text-4xl font-extrabold title-font gradient-text">
                            Selamat Datang, <?php echo e(Auth::user()->Nama_Pengguna); ?>!
                        </h1>
                ...
                <div class="bg-white/90 backdrop-blur-xl rounded-2xl p-8 custom-shadow animate-fade-up-delay">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <p class="text-2xl font-bold text-orange-600"><?php echo e(number_format($totalMakananDiselamatkan ?? 2500)); ?> Porsi</p>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <p class="text-2xl font-bold text-green-600"><?php echo e(number_format($limbahDicegah ?? 1250, 2)); ?> Kg</p>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <p class="text-2xl font-bold text-blue-600"><?php echo e($komunitasTerbantu ?? 500); ?></p>
        ...
        <div class="bg-white/70 backdrop-blur-xl rounded-2xl p-10 custom-shadow mb-16">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
                ...
                <div class="flex space-x-4 mt-4 sm:mt-0">
                    ...
                    <a href="<?php echo e(route('pengguna.food-listing.index')); ?>" 
            ...
            <?php if(empty($availableMakanans) || $availableMakanans->isEmpty()): ?>
            ...
            <?php else: ?>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__currentLoopData = $availableMakanans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $makanan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white rounded-2xl p-6 custom-shadow hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 animate-fade-up">
                            <div class="relative h-52 w-full rounded-xl overflow-hidden mb-4 bg-gray-100">
                                <img src="<?php echo e($makanan->Foto_Makanan ? asset('storage/' . $makanan->Foto_Makanan) : asset('images/food-placeholder.jpg')); ?>" 
                                     alt="<?php echo e($makanan->Nama_Makanan); ?>" 
                            ...
                            <h3 class="text-lg font-semibold text-gray-800 truncate"><?php echo e($makanan->Nama_Makanan); ?></h3>
                            <p class="text-sm text-gray-500 mt-1">Jumlah: <?php echo e($makanan->Jumlah_Makanan); ?> porsi</p>
                            <p class="text-sm text-gray-500 mt-1">Donatur: <?php echo e($makanan->donatur->Nama_Pengguna ?? 'Anonim'); ?></p>
                            ...
                            <div class="mt-4 flex gap-3">
                                <a href="<?php echo e(route('pengguna.food-listing.show', $makanan->ID_Makanan)); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmad\Documents\Project\FoodSaver-SI4609-Kelompok3\resources\views/dashboard-pengguna.blade.php ENDPATH**/ ?>
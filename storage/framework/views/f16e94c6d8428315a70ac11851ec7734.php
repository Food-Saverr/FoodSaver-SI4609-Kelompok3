    ...
    <header class="fixed top-0 w-full bg-gradient-to-r from-orange-500 to-orange-600 shadow z-50 transition-all duration-500 h-16 md:h-20">
        ...
        <nav class="hidden md:flex items-center space-x-6">
            ...
            >
                ...
                <img src="<?php echo e(asset('storage/' . Auth::user()->foto)); ?>" alt="Profile"
                ...
                <?php endif; ?>
                <span class="hidden md:inline"><?php echo e(Auth::user()->Nama_Pengguna); ?></span>
            ...
            >
                ...
                <?php if(Auth::user()->foto): ?>
                    <img src="<?php echo e(asset('storage/' . Auth::user()->foto)); ?>" class="w-10 h-10 rounded-full object-cover border-2 border-white shadow">
                <?php else: ?>
                    <i class="fas fa-user-circle text-3xl text-orange-600"></i>
                <?php endif; ?>
                <div>
                    <p class="text-sm font-semibold text-gray-700"><?php echo e(Auth::user()->Nama_Pengguna); ?></p>

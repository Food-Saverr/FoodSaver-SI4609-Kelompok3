...
<body class="min-h-screen flex bg-gradient-to-br from-orange-50 to-gray-100">
    ...
    <div class="flex-1 flex items-center justify-center px-6 py-3">
        <div class="w-full max-w-lg bg-white/70 backdrop-blur-xl rounded-3xl p-10 custom-shadow animate-fade-up">
            ...
            <!-- Form -->
            <form action="<?php echo e(route('registrasi')); ?>" method="POST" class="space-y-5">
                <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                value="<?php echo e(old('Email_Pengguna')); ?>"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                value="<?php echo e(old('Nama_Pengguna')); ?>"
                                class="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 bg-white/90 focus:outline-none focus:border-orange-400 input-focus-effect transition-all"
                                required
                            />
                        </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea
                            ...
                            class="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 bg-white/90 focus:outline-none focus:border-orange-400 input-focus-effect transition-all"
                            required
                        ><?php echo e(old('Alamat_Pengguna')); ?></textarea>
                    </div>
                </div>
...
</html><?php /**PATH C:\Users\ahmad\Documents\Project\FoodSaver-SI4609-Kelompok3\resources\views/auth/registrasi.blade.php ENDPATH**/ ?>
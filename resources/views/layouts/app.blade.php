    ...
    <header class="fixed top-0 left-0 w-full z-50 transition duration-300 ease-in-out bg-white shadow-sm">
        <div class="container mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <nav class="hidden md:flex space-x-10 text-sm font-semibold">
                <a href="{{ route('dashboard.pengguna') }}" class="navbar-link hover:text-orange-600 {{ request()->routeIs('dashboard.pengguna') ? 'active gradient-text' : 'text-gray-700' }}">
        ...
        <div class="md:hidden hidden" id="mobileMenu">
            <div class="px-4 pt-3 pb-4 space-y-2 bg-white border-t border-gray-100 shadow-sm">
                <a href="{{ route('dashboard.pengguna') }}" class="flex items-center px-4 py-3 rounded-lg text-base font-medium {{ request()->routeIs('dashboard.pengguna') ? 'bg-orange-100 text-orange-600' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }} transition duration-150">

    ...
    <header class="fixed top-0 left-0 w-full z-50 transition duration-300 ease-in-out bg-white shadow-sm">
        <div class="container mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <nav class="hidden md:flex space-x-10 text-sm font-semibold">
                ...
                <a href="{{ route('artikel.donatur') }}" class="navbar-link hover:text-orange-600 text-gray-700">
                    ...
                    <div x-data="{ open: false }" class="relative" @keydown.escape="open = false">
                        ...
                        <div x-show="open" @click.away="open = false" 
                            ...
                            <form id="logout-form" action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button dusk="logout-button" type="submit" class="flex items-center w-full text-left px-5 py-3 text-sm text-red-600 hover:bg-red-50 hover:text-red-700 transition duration-150">

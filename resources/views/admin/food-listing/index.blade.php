...
<div class="container mx-auto px-4 py-8 pt-28">
    <div class="bg-white/70 backdrop-blur-xl rounded-2xl p-8 custom-shadow">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            ...
            <a href="{{ route('admin.food-listing.create') }}" class="mt-4 md:mt-0 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white py-2.5 px-6 rounded-xl font-semibold transition animate-scale shadow-lg shadow-orange-200">
            ...
            <table class="min-w-full bg-white rounded-xl overflow-hidden">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-orange-50 transition duration-150">
                        ...
                        @if(Auth::user()->Role_Pengguna === 'Admin')
                            <td class="py-3 px-4">
                                {{ optional($makanan->donatur)->Nama_Pengguna ?: 'Pengguna ' . $makanan->ID_Pengguna }}
                            </td>
                        @endif
                        <td class="py-3 px-4 text-center">
                            <div class="flex justify-center space-x-2">
                                ...
                                @if(Auth::user()->Role_Pengguna === 'Admin' || 
                                    ...
                                    <a href="{{ route('admin.food-listing.edit', $makanan->ID_Makanan) }}" 
                    ...
                    @empty
                    <tr>
                        <td colspan="{{ Auth::user()->Role_Pengguna === 'Admin' ? '8' : '7' }}" class="py-8 text-center text-gray-500">

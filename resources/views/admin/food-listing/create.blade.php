                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            >
                                ...
                                <option value="Makanan Pokok" {{ old('Kategori_Makanan') == 'Makanan Pokok' ? 'selected' : '' }}>Makanan Pokok</option>
                                ...
                                <option value="Protein Hewani" {{ old('Kategori_Makanan') == 'Protein Hewani' ? 'selected' : '' }}>Protein Hewani</option>
                                <option value="Protein Nabati" {{ old('Kategori_Makanan') == 'Protein Nabati' ? 'selected' : '' }}>Protein Nabati</option>
                                <option value="Makanan Ringan" {{ old('Kategori_Makanan') == 'Makanan Ringan' ? 'selected' : '' }}>Makanan Ringan</option>
                                <option value="Makanan Siap Saji" {{ old('Kategori_Makanan') == 'Makanan Siap Saji' ? 'selected' : '' }}>Makanan Siap Saji</option>
                                <option value="Minuman" {{ old('Kategori_Makanan') == 'Minuman' ? 'selected' : '' }}>Minuman</option>
                                <option value="Lainnya" {{ old('Kategori_Makanan') == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                            </select>
                        </div>
                    </div>

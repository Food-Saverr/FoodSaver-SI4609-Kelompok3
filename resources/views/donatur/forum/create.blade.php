...
<div class="container mx-auto px-4 py-8 pt-24 relative z-10">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="fixed bottom-10 right-10 z-50">
            <button type="submit" form="createPostForm" class="flex items-center justify-center w-16 h-16 bg-gradient-to-r from-blue-500 to-blue-600 shadow-xl rounded-full hover:shadow-blue-200/50 hover:-translate-y-1 transition-all overflow-hidden group">
        ...
        <!-- Breadcrumb -->
        <a href="{{ route('donatur.forum.index') }}" class="text-sm text-blue-600 flex items-center hover:text-blue-700 transition-colors group mb-6 w-max">
        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl p-6 lg:p-8 shadow-xl shadow-gray-100/80 border border-gray-100">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-8 pb-8 border-b border-gray-100">
                <div class="flex-shrink-0">
                    <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white shadow-lg transform rotate-3 hover:rotate-6 transition-transform overflow-hidden">
            ...
            <form action="{{ route('donatur.forum.store') }}" method="POST" enctype="multipart/form-data" id="createPostForm" class="space-y-8">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    <div class="bg-gradient-to-r from-blue-50/50 to-indigo-50/50 rounded-2xl p-5 border border-blue-100/80 mt-5 relative overflow-hidden" id="attachment-container" style="display: none;">
                        <!-- Decoration dots -->
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div class="text-sm font-semibold text-gray-700 flex items-center">
                                ...
                                <span class="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800" id="attachment-count">
                                    0 file
                                </span>
                            </div>
                        </div>
                ...
                <div class="pt-6 flex flex-col-reverse sm:flex-row gap-4 justify-between">
                    <a href="{{ route('donatur.forum.index') }}" class="flex items-center justify-center px-6 py-3.5 bg-white border border-gray-300 rounded-xl text-gray-700 font-medium shadow-sm hover:bg-gray-50 hover:border-gray-400 transition-all duration-300">
                    ...
                    <button type="submit" id="submit-btn" class="flex items-center justify-center px-8 py-3.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium rounded-xl shadow-lg shadow-blue-100 hover:shadow-blue-200/50 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300">
...
<div class="container mx-auto px-4 pb-16 relative z-10">
    <div class="max-w-4xl mx-auto mt-8">
        <div class="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-3xl shadow-lg overflow-hidden border border-blue-100/50">
            <div class="p-0.5 bg-gradient-to-r from-blue-400/20 to-indigo-500/20">
                <div class="grid grid-cols-1 md:grid-cols-3">
                    ...
                    <div class="p-6 md:col-span-1 flex md:flex-col md:items-start items-center gap-4 border-b md:border-b-0 md:border-r border-blue-100/50">
                        <div class="w-12 h-12 md:w-16 md:h-16 rounded-xl bg-gradient-to-br from-blue-400 to-indigo-600 flex items-center justify-center text-white shadow-lg transform md:rotate-3 hover:rotate-6 transition-transform">
                            <i class="fas fa-lightbulb text-xl md:text-2xl"></i>
                        </div>
                        <div>
                            <h3 class="font-bold text-xl text-indigo-800">Tips Menulis</h3>
                            <p class="text-indigo-600 text-sm">Untuk postingan berkualitas</p>
                        </div>
                    </div>
                ...
                reader.onload = function(e) {
                    ...
                    if (file.type.startsWith('image/')) {
                        ...
                        attachmentCard.innerHTML = `
                            <div class="flex bg-white rounded-xl overflow-hidden shadow-sm border border-blue-100/60 transition-all duration-300 hover:shadow-md hover:border-blue-200">
                                ...
                                <div class="flex-grow p-3 flex flex-col justify-between relative overflow-hidden">
                                    ...
                                    <div class="flex items-center justify-between mt-1">
                                        <a href="#" class="text-xs text-blue-600 hover:text-blue-800 transition-colors flex items-center preview-image-btn">

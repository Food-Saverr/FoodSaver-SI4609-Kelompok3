...
<div class="container mx-auto px-4 py-8 pt-24 relative z-10">
    <div class="max-w-4xl mx-auto">
        ...
        <!-- Breadcrumb -->
        <a href="{{ route('donatur.forum.show', $post->ID_ForumPost) }}" class="text-sm text-blue-600 flex items-center hover:text-blue-700 transition-colors group mb-6 w-max">
        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl p-6 lg:p-8 shadow-xl shadow-gray-100/80 border border-gray-100">
            ...
            <form action="{{ route('donatur.forum.update', $post->ID_ForumPost) }}" method="POST" enctype="multipart/form-data" id="editPostForm" class="space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="pt-6 flex flex-col-reverse sm:flex-row gap-4 justify-between">
                    <a href="{{ route('donatur.forum.show', $post->ID_ForumPost) }}" class="flex items-center justify-center px-6 py-3.5 bg-white border border-gray-300 rounded-xl text-gray-700 font-medium shadow-sm hover:bg-gray-50 transition-colors">

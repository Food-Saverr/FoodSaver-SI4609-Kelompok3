...
<!-- Hero Section -->
<div class="relative min-h-[400px] flex items-center overflow-hidden bg-gradient-to-r from-blue-600 to-blue-500 shadow-xl">
    <!-- Animated Shapes -->
    ...
    <div class="container mx-auto px-4 py-16 relative z-10">
        <div class="max-w-3xl">
            <h1 class="mt-12 text-4xl lg:text-5xl font-bold text-white mb-4 flex items-center animate-fadeInDown">
                <span class="bg-white text-blue-600 p-2 rounded-lg mr-4 shadow-lg transform -rotate-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M18 10c0 3.866-3.582 7-8 7a8.841 8.841 0 01-4.083-.98L2 17l1.338-3.123C2.493 12.767 2 11.434 2 10c0-3.866 3.582-7 8-7s8 3.134 8 7zM7 9H5v2h2V9zm8 0h-2v2h2V9zM9 9h2v2H9V9z" clip-rule="evenodd" />
                    </svg>
                </span>
                <span class="drop-shadow-xl">Forum Diskusi</span>
            </h1>
            ...
            <div class="flex flex-wrap gap-4 animate-fadeInUp animation-delay-600">
                <a href="{{ route('donatur.forum.create') }}" class="relative overflow-hidden group inline-flex items-center px-6 py-3.5 bg-white text-blue-600 font-medium rounded-xl shadow-lg transition-all duration-300 hover:shadow-blue-900/20 transform hover:-translate-y-1">
                    ...
                    <span class="absolute inset-0 bg-gradient-to-r from-blue-50 to-white scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-500"></span>
                ...
                <button type="button" id="filterButton" class="relative overflow-hidden group inline-flex items-center px-6 py-3.5 bg-blue-700 text-white font-medium rounded-xl shadow-lg transition-all duration-300 hover:shadow-blue-900/30 transform hover:-translate-y-1">
                    <span class="absolute inset-0 bg-gradient-to-r from-blue-700 to-blue-600 group-hover:scale-x-0 transition-transform origin-left duration-500"></span>
                    <span class="absolute inset-0 bg-gradient-to-r from-blue-800 to-blue-700 scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-500"></span>
    ...
    <!-- Decorative Wave -->
    <div class="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-b from-blue-500/0 to-blue-500">
...
<div class="container mx-auto px-4 relative z-20">
    ...
    <div id="filterPanel" class="z-30 bg-white shadow-xl rounded-2xl mx-auto max-w-3xl -mt-6 transform transition-all duration-500 scale-y-0 origin-top opacity-0 mb-4 absolute left-0 right-0">
        <div class="p-6">
            <form action="{{ route('donatur.forum.index') }}" method="GET" class="space-y-6" id="filterForm">
                <div class="flex flex-col md:flex-row gap-4">
                    <div class="flex-grow">
                        ...
                        <div class="relative">
                            <input type="text" name="search" placeholder="Cari berdasarkan judul atau konten" 
                                ...
                                class="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl bg-gray-50/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">
                    ...
                    <div class="w-full md:w-48">
                        ...
                        <select name="sort" class="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">
                ...
                <div class="flex justify-end space-x-3 pt-4 border-t border-gray-100">
                    <a href="{{ route('donatur.forum.index') }}" class="px-5 py-2.5 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-all">
                        Reset
                    </a>
                    <button type="submit" class="px-5 py-2.5 bg-blue-600 text-white rounded-lg shadow-sm hover:shadow hover:bg-blue-700 transition-all">
                        Terapkan Filter
                    </button>
                </div>
            </form>
    ...
    <div class="max-w-2xl mx-auto mt-20">
        <div class="relative">
            <form id="quickSearchForm" action="{{ route('donatur.forum.index') }}" method="GET">
                <input type="text" id="quickSearch" name="search" placeholder="Cari diskusi..." 
                    value="{{ request('search') }}" 
                    class="w-full py-4 pl-14 pr-12 text-gray-700 bg-white rounded-full shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-300 transition-all">
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-5">
                    <button type="submit" class="text-blue-500 hover:text-blue-600" id="quickSearchButton">
                ...
                <div class="absolute inset-y-0 right-12 flex items-center">
                    <a href="{{ route('donatur.forum.index') }}" class="text-gray-400 hover:text-gray-600">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div class="mt-2 text-center">
            <span class="text-sm text-gray-600">
                ...
                <a href="{{ route('donatur.forum.index') }}" class="ml-2 text-blue-500 hover:text-blue-600 font-medium">
                    Hapus pencarian
                </a>
            </span>
        </div>
...
<div class="container mx-auto px-4 pb-16 mt-8">
    @if(session('success'))
        <div id="successAlert" class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded-r-lg shadow-md animate-fadeIn">
            <div class="flex">
                ...
                <div class="ml-auto pl-3">
                    <div class="-mx-1.5 -my-1.5">
                        <button type="button" onclick="document.getElementById('successAlert').remove()" class="inline-flex rounded-md p-1.5 text-blue-500 hover:bg-blue-100 focus:outline-none">
    ...
    @if($posts->isEmpty())
        ...
        <div class="max-w-3xl mx-auto bg-white rounded-3xl shadow-xl p-10 text-center transform transition-all hover:shadow-2xl animate-fadeIn">
            <div class="bg-blue-50 rounded-full w-24 h-24 flex items-center justify-center mx-auto mb-8">
            ...
            <p class="text-gray-600 mb-8 max-w-md mx-auto">
                @if(request('search'))
                    Coba gunakan kata kunci yang berbeda atau <a href="{{ route('donatur.forum.index') }}" class="text-blue-500 hover:text-blue-600 font-medium">lihat semua postingan</a>.
                @else
                    Jadilah yang pertama membuat postingan di forum ini dan mulai berbagi pengalaman Anda!
                @endif
            </p>
            <a href="{{ route('donatur.forum.create') }}" class="inline-flex items-center px-6 py-3.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium rounded-xl shadow-lg hover:shadow-blue-200/50 transform transition-all hover:-translate-y-1 active:translate-y-0">
    ...
    @else
        <div class="grid grid-cols-1 gap-6 mb-10">
            ...
            @foreach($posts as $post)
                <div class="animate-fadeIn animation-delay-{{ $loop->index * 100 }}">
                    <a href="{{ route('donatur.forum.show', $post->ID_ForumPost) }}" class="bg-white/80 backdrop-blur-xl rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1 overflow-hidden block border border-gray-100/50">
                        <div class="p-6">
                            <div class="flex flex-col md:flex-row md:items-start">
                                <!-- User Avatar with Animation -->
                                <div class="flex-shrink-0 mb-4 md:mb-0 md:mr-6 group">
                                    <div class="relative">
                                        <div class="absolute inset-0 rounded-full bg-gradient-to-br from-blue-400 to-blue-500 opacity-10 group-hover:opacity-30 transform group-hover:scale-110 transition-all duration-300"></div>
                                        <img src="{{ $post->pengguna->foto ? asset('storage/'.$post->pengguna->foto) : asset('images/default-avatar.png') }}" 
                                            ...
                                            alt="{{ $post->pengguna->Nama_Pengguna ?? 'Anonim' }}"
                                            onerror="this.src='https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp&s=80'">
                                        <div class="absolute -bottom-0.5 -right-0.5 w-5 h-5 rounded-full bg-blue-100 border-2 border-white flex items-center justify-center">
                                ...
                                <div class="flex-grow">
                                    ...
                                    <h2 class="text-xl font-bold mb-2 transition-colors group-hover:text-blue-700">
                                    ...
                                    <div class="flex flex-wrap gap-4 text-sm text-gray-500 mb-3">
                                        <span class="flex items-center">
                                            ...
                                            <span class="truncate max-w-[120px]">{{ $post->pengguna->Nama_Pengguna }}</span>
                                        </span>
                                        <span class="flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    @if(isset($post->tags) && count($post->tags) > 0)
                                        <div class="mt-4 flex flex-wrap gap-2">
                                            @foreach($post->tags as $tag)
                                                <span class="inline-block px-3 py-1 bg-blue-100 text-blue-600 text-xs font-medium rounded-full tag-bubble">
                                                    #{{ $tag->Nama_Pengguna }}
                                                </span>
                                            @endforeach
                                        </div>
                        ...
                        <div class="bg-gray-50/80 px-6 py-3 flex justify-between items-center border-t border-gray-100">
                            ...
                            <span class="text-blue-600 font-medium text-sm flex items-center group-hover:text-blue-700">
        ...
        <div class="mt-16">
            <h2 class="text-xl font-bold text-center mb-8 text-gray-800 relative">
                <span class="bg-gradient-to-r from-blue-500 to-blue-600 bg-clip-text text-transparent">Statistik Forum</span>
                <div class="absolute h-1 w-20 bg-blue-500 bottom-0 left-1/2 transform -translate-x-1/2"></div>
            </h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                ...
                <div class="bg-white/80 backdrop-blur-xl rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1 overflow-hidden border border-gray-100/50 p-6 flex flex-col items-center text-center">
                    ...
                    <!-- Animated Accent Line -->
                    <div class="mt-4 w-1/2 h-1 bg-blue-100 relative overflow-hidden rounded-full">
                        <div class="absolute inset-0 bg-blue-400 animate-pulse-slow animation-delay-300"></div>
                    </div>
                </div>
                ...
                <div class="bg-white/80 backdrop-blur-xl rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1 overflow-hidden border border-gray-100/50 p-6 flex flex-col items-center text-center">
                    ...
                    <!-- Animated Accent Line -->
                    <div class="mt-4 w-1/2 h-1 bg-blue-100 relative overflow-hidden rounded-full">
                        <div class="absolute inset-0 bg-blue-400 animate-pulse-slow animation-delay-600"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mt-16 max-w-5xl mx-auto bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl p-8 shadow-sm">
            <div class="flex flex-col md:flex-row items-center">
                <div class="md:w-1/2 mb-6 md:mb-0 md:pr-8">
                    ...
                    <a href="{{ route('donatur.forum.create') }}" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium rounded-xl shadow-lg transition-all transform hover:-translate-y-1 hover:shadow-blue-200/50">
                ...
                <div class="md:w-1/2 flex justify-center">
                    <div class="relative">
                        <div class="absolute -top-4 -left-4 w-16 h-16 bg-blue-200/50 rounded-full"></div>
                        <div class="absolute -bottom-6 -right-6 w-24 h-24 bg-indigo-200/50 rounded-full"></div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (resetButton) {
        resetButton.addEventListener('click', function(e) {
            e.preventDefault();
            window.location.href = '{{ route("donatur.forum.index") }}';
        });
    }
});
</script>

...
<div class="container mx-auto px-4 py-8 pt-28">
    <div class="max-w-4xl mx-auto">
        <!-- Navigasi -->
        <a href="{{ route('pengguna.donation.index') }}" class="text-sm text-orange-500 flex items-center hover:text-orange-700 transition-colors group mb-4">
                    ...
                    <div class="p-6 bg-gray-50 rounded-xl">
                        ...
                        <div class="relative">
                            ...
                            <div class="relative flex items-start mb-4 pl-16">
                                ...
                                <div>
                                    <h4 class="font-medium">Donasi Dibuat</h4>
                            ...
                            @if($donation->status == 'Disetujui')
                                <div class="relative flex items-start mb-4 pl-16">
                                    <div class="absolute left-0 rounded-full w-12 h-12 flex items-center justify-center bg-blue-100 text-blue-600">
                                        <i class="fas fa-check-circle text-lg"></i>
                                    </div>
                                    <div>
                                        <h4 class="font-medium">Donasi Diterima</h4>
                                        <p class="text-sm text-gray-500">
                        ...
                        <div class="p-6 bg-gray-50 rounded-xl">
                            ...
                            <div class="flex items-center space-x-3">
                                @if($donation->status == 'Pending')
                                    ...
                                    <p class="text-sm text-gray-600">Donasi Anda sedang ditinjau</p>
                                @elseif($donation->status == 'Disetujui')
                                    <span class="px-4 py-2 bg-green-100 text-green-800 rounded-full text-sm font-medium">
                                        <i class="fas fa-check-circle mr-1"></i>Diterima
                                    </span>
                                    <p class="text-sm text-gray-600">Donasi Anda telah diterima</p>
                                @endif
                            </div>
                        </div>
                    </div>

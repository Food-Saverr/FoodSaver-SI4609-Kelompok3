...
<div class="container mx-auto px-4 py-8 pt-28">
    <div class="bg-white/70 backdrop-blur-xl rounded-2xl p-8 custom-shadow">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            ...
            <a href="{{ route('pengguna.donation.create') }}" class="mt-4 md:mt-0 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white py-2.5 px-6 rounded-xl font-semibold transition animate-scale shadow-lg shadow-orange-200">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-orange-50 transition duration-150">
                        ...
                        <td class="py-3 px-4 text-center">
                            <a href="{{ route('pengguna.donation.show', $donation->id) }}" 
